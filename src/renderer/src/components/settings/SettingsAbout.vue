...
<template>
  <div class="about-section">
    ...
    <div class="about-info">
      <div class="info-row">
        <span class="info-label">Electron</span><span class="info-value">39.2.6</span>
      </div>
      <div class="info-row">
        <span class="info-label">Vue</span><span class="info-value">3.5.25</span>
      </div>
      <div class="info-row">
        <span class="info-label">Node.js</span><span class="info-value">20.11.0</span>
      </div>
    </div>
