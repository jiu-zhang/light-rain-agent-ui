...
/**
 * 统一图标组件 - 基于 Lucide 风格的内联 SVG 图标集
 * 所有图标使用 currentColor，通过 CSS 控制颜色
 */
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'brain'">
      <path d="M12 2a4 4 0 0 0-4 4v1a3 3 0 0 0-3 3 3 3 0 0 0 1 2.24V13a3 3 0 0 0 2 2.83V17a3 3 0 0 0 6 0v-1.17A3 3 0 0 0 16 13v-.76A3 3 0 0 0 17 10a3 3 0 0 0-3-3V6a4 4 0 0 0-4-4z" />
    </template>
