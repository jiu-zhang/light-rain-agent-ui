...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'brain'">
      <path
        d="M12 2a4 4 0 0 0-4 4v1a3 3 0 0 0-3 3 3 3 0 0 0 1 2.24V13a3 3 0 0 0 2 2.83V17a3 3 0 0 0 6 0v-1.17A3 3 0 0 0 16 13v-.76A3 3 0 0 0 17 10a3 3 0 0 0-3-3V6a4 4 0 0 0-4-4z"
      />
    </template>
